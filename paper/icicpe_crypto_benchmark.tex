...
compares naive and historical-mean baselines, ARIMA, XGBoost, GARCH as a
volatility-only baseline, LSTM, N-BEATS, PatchTST, Temporal Fusion Transformer,
and the zero-shot Chronos foundation model. Forecasts are evaluated at one-day
and seven-day horizons over 237 asset-splits per target, horizon, and
...
baselines matter as much as model class. Future work will add volatility-regime
error analysis and include probabilistic scores for models that produce
predictive distributions.

\section*{Acknowledgments}
The author acknowledges WorldQuant University as the submission affiliation
for ICICPE 2026.
